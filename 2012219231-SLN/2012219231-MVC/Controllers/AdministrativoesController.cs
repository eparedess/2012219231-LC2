...
namespace _2012219231_MVC.Controllers
{
    public class AdministrativoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmpleadoId")] Administrativo administrativo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmpleadoId")] Administrativo administrativo)
        {
            if (ModelState.IsValid)
            {
